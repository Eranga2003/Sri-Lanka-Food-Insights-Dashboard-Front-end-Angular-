      ...
      <mat-card class="page-card">
        <div class="page-header">
          <div>
            ...
            <h1>Disease / Fungal Attack</h1>
            <p class="lede">
              Capture disease names, impact %, severity, and affected food types for heatmaps and
              alerts.
            </p>
          </div>
        ...
        <div class="placeholder">
          Form coming next: year, month, province, disease name, severity, affected food, impact
          percent.
        </div>
      </mat-card>
    </section>
